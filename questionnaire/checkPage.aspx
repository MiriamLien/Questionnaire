...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="userInfoQuesChk">
        ...
        <asp:Literal ID="ltlPhoneAns" runat="server" TextMode="Phone"></asp:Literal><br />
        <asp:Literal ID="ltlEmail" runat="server">Email</asp:Literal>
        <asp:Literal ID="ltlEmailAns" runat="server" TextMode="Email"></asp:Literal><br />
        <asp:Literal ID="ltlAge" runat="server">年齡</asp:Literal>
        <asp:Literal ID="ltlAgeAns" runat="server" TextMode="Number"></asp:Literal><br />
        <br />
        <br />
        <br />
        <p></p>
